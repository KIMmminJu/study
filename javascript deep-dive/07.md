...
- 산술 연산자는 피연산자의 개수에 따라 이항 산술 연산자와 단항 서술 연산자
...
- 값이 null 타입인지 확인할 때는 일치 연산자(===)를 사용해야한다. 

>> Object.ptototype.toString 을 사용하여 typeof 연산자의 하위 타입도 구분할 수 있다.
>> 배열은 Array.isArray 함수를 사용하여 구분할 수 있다.
